...
class Gui(threading.Thread):
    ...
    def connectionButton (self, event):
        ...
        self.connectToIP = Button(self.connectionWindow, text = "Set", padx = 5, pady = 5, command = self.setIP)
    ...
    def run(self):
        ...
        self.mainWindow.title("Frle Messenger 0.97 Beta")
...
try:
    ...
    peerName = receiver.recv(4096)
    clientSocket.send(str.encode(root.username))
